...
public class Datasource {
    ...
    public static final String QUERY_ARTIST_FOR_SONG_START =
            "SELECT " + TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME + ", " +
                    ...
                    " ON " + TABLE_SONGS + "." + COLUMN_SONG_ALBUM + " = " + TABLE_ALBUMS + "." + COLUMN_ARTIST_ID +
...
// CONTINUE FROM SECTION 19 CHAPTER 27
    ...
    //    trying to get schema information from the table
    public void querySongsMetaData() throws SQLException {
    ...
    public int getCount(String table) throws SQLException {
        ...
        try (Statement statement = conn.createStatement();
            ...
            int count = results.getInt(1); // gives the count of the first column
            return count;
        } catch (SQLException e) {
            System.out.println("Query failed: " + e.getMessage());
            return -1;
